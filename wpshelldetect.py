...
import os
import hashlib, string, random, concurrent.futures
...
# Membersihkan layar sesuai sistem operasi
...
r = """\033[1;32;40m
   ...
   / /_/ / /_/ / / /    
  /_____/\____/ /_/     
                            \033[1;33;40m(Version:1.2a)
                     \033[1;36;40mWORDPRESS SHELL DETECTOR (162 types)
\033[1;32;40m  Modified by S
                 PRIVATE USE ONLY
"""
print(r)
...
# Fungsi untuk menjalankan kode eksploitasi
def run_code(site):
    try:
        logging.info(f"Mulai eksploitasi pada: {site}")

        # Daftar semua fungsi eksploitasi yang tersedia
        exploit_functions = [exploit_1(site), exploit_2(site), exploit_3(site), exploit_4(site), exploit_5(site),exploit_6(site), exploit_7(site), exploit_8(site), exploit_9(site), exploit_11(site),exploit_12(site), exploit_13(site), exploit_14(site), exploit_15(site), exploit_16(site),exploit_17(site), exploit_18(site), exploit_19(site), exploit_20(site), exploit_21(site),exploit_22(site), exploit_23(site), exploit_24(site), exploit_25(site), exploit_26(site),exploit_27(site), exploit_28(site), exploit_29(site), exploit_30(site), exploit_31(site),exploit_32(site), exploit_33(site), exploit_34(site), exploit_35(site), exploit_36(site),exploit_37(site), exploit_38(site), exploit_39(site), exploit_40(site), exploit_41(site),exploit_42(site), exploit_43(site), exploit_44(site), exploit_45(site), exploit_46(site),exploit_47(site), exploit_48(site), exploit_49(site), exploit_50(site), exploit_51(site),exploit_52(site), exploit_53(site), exploit_54(site), exploit_55(site), exploit_56(site),exploit_57(site), exploit_58(site), exploit_59(site), exploit_60(site), exploit_61(site),exploit_62(site), exploit_63(site), exploit_64(site), exploit_65(site), exploit_66(site),exploit_67(site), exploit_68(site), exploit_69(site), exploit_70(site), exploit_71(site),exploit_72(site), exploit_73(site), exploit_74(site), exploit_75(site), exploit_76(site),exploit_77(site), exploit_78(site), exploit_79(site), exploit_80(site), exploit_81(site),exploit_82(site), exploit_83(site), exploit_84(site), exploit_85(site), exploit_86(site),exploit_87(site), exploit_88(site), exploit_89(site), exploit_90(site), exploit_91(site),exploit_92(site), exploit_93(site), exploit_94(site), exploit_95(site), exploit_96(site),exploit_97(site), exploit_98(site), exploit_99(site), exploit_100(site), exploit_101(site),exploit_102(site), exploit_103(site), exploit_104(site), exploit_105(site), exploit_106(site),exploit_107(site), exploit_108(site), exploit_109(site), exploit_110(site), exploit_111(site),exploit_112(site), exploit_113(site), exploit_114(site), exploit_115(site), exploit_116(site),exploit_117(site), exploit_118(site), exploit_119(site), exploit_120(site), exploit_121(site),exploit_122(site), exploit_123(site), exploit_124(site), exploit_125(site), exploit_126(site),exploit_127(site), exploit_128(site), exploit_129(site), exploit_130(site), exploit_131(site),exploit_132(site), exploit_133(site), exploit_134(site), exploit_135(site), exploit_136(site),exploit_137(site), exploit_138(site), exploit_139(site), exploit_140(site), exploit_141(site), exploit_142(site), exploit_143(site), exploit_144(site), exploit_145(site), exploit_146(site), exploit_147(site), exploit_148(site), exploit_149(site), exploit_150(site), exploit_151(site),exploit_152(site), exploit_153(site), exploit_154(site), exploit_155(site), exploit_156(site),exploit_157(site), exploit_158(site), exploit_159(site), exploit_160(site), exploit_161(site),exploit_162(site)]


        # Iterasi dan jalankan setiap fungsi eksploitasi
        for exploit_func in exploit_functions:
            if exploit_func is not None:  # Cek apakah fungsi valid
                try:
                    exploit_func(site)
                    logging.info(f"Eksploitasi {exploit_func.__name__} berhasil pada: {site}")
                except Exception as e:
                    logging.error(f"Gagal menjalankan {exploit_func.__name__} pada: {site} - Error: {e}")
            else:
                logging.error(f"Fungsi eksploitasi tidak valid untuk: {site}")
    except Exception as e:
        logging.error(f"Gagal menjalankan eksploitasi pada: {site} - Error: {e}")

# Membaca file daftar target dan menjalankan multi-threading
